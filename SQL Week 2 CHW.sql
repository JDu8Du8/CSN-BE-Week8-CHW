...
select sum(s.salary) as "Total Salaries between 1990 and 1992" from salaries s  join dept_emp d on d.emp_no = s.emp_no where d.from_date between '1990-01-01' and '1991-12-31' and d.dept_no  = 'd001' group by d.dept_no;