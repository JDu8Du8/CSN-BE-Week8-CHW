...
select sum(s.salary) as "1990 - 1992 Total Salaries" from salaries s  join dept_emp d on d.emp_no = s.emp_no where d.from_date between '1990-01-01' and '1992-12-31' and d.dept_no  = 'd001' group by d.dept_no;